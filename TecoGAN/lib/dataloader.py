...
def inference_data_loader(FLAGS):
    ...
    image_list_LR_temp_ = os.listdir(filedir)
    image_list_LR_temp = [_ for _ in image_list_LR_temp_ if _.endswith(".png")]
    if len(image_list_LR_temp) == 0:
        image_list_LR_temp = [_ for _ in image_list_LR_temp_ if _.endswith(".jpg")]
